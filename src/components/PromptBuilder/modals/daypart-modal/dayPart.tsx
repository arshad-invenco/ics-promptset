...
function DayPartModal({ hide, daypart }: ModalProps) {
  ...
  const handleSelect = (item: DaypartItem) => {
    ...
    axios
      .post(
        "https://api-martini.invencocloud.com/rest/v1/media/promptsets/7b6b43c8-080c-4548-8618-362db74e77dd/prompts/e1327a34-ef58-49f3-b792-c66e2d4d9e44/exception",
        payload,
        {
