...
export default function TreeElements(props: TreeElementsProps) {
    ...
    return (<>
            {element.type === "text" ? (
                ...
                : element.type === "input" ? (<div className="element input-element-value">
                    <div className="element-left-container text-capitalize">
                        <DragIndicatorRoundedIcon className="grab-icon"/>
                ...
                </div>) : element.type === "bg" ? (<div className="element input-element-value">
                    <div className="element-left-container text-capitalize">
                ...
                </div>) : element.type === "image" ? (<div className="element input-element-value">
                    <div className="element-left-container text-capitalize">
                        <DragIndicatorRoundedIcon className="grab-icon"/>
                ...
                </div>) : element.type === "video" ? (<div className="element input-element-value">
                    <div className="element-left-container text-capitalize">
